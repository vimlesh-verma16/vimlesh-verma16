...
- **M.Tech in Computer Science and Engineering**  
  **National Institute of Technology (NIT Durgapur)** (2021 – 2023)
...
### **Software Development Engineer III** | Jio Platforms *(Jul 2025 – Present)*
- Building production-scale AI platforms powered by LLMs and Agentic AI.
- Designed LLM routing engines, memory architectures, conversational AI, and event-driven microservices.
- Built Voice AI services integrating STT, TTS, and LLMs for real-time voice-to-voice conversations.
...
- **AWS Certified Cloud Practitioner CLF-C02** (Jan 2025) [Certificate](https://www.udemy.com/certificate/UC-1adf5b2e-b239-42e6-a399-76cfa6833a7a/)  
- **HackerRank Python Certificate** (June 2021) [Certificate](https://www.hackerrank.com/certificates/a6632440fdcd)  
- **Flipkart Grid 4.0 Software Development Challenge** (April 2022) [Certificate](https://unstop.com/certificate-preview/6d14fdf5-0f73-422d-b4b1-95da8b3accf3)
